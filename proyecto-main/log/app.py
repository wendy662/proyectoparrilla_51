...
# ===================== EDITAR PRODUCTO =====================
@app.route("/editar_producto_em/<int:id_producto>", methods=["POST"])
...
# ===================== ELIMINAR PRODUCTO =====================
@app.route("/eliminar_producto_em/<int:id_producto>")
...
def agregar_reserva():
    ...
    cur = mysql.connection.cursor()
    cur.execute("""
        INSERT INTO reservas (fecha, hora, cant_personas, estado, cod_mesa,
        telefono, id_usuario)
...
@app.route('/cambiar_estado_empleado/<int:id_reserva>/<string:cod_mesa>')
def cambiar_estado_empleado(id_reserva, cod_mesa):
    cur = mysql.connection.cursor()
